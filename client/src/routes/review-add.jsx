...
export default function ReviewAdd() {
  ...
  return (
    <Form className="row profile-form" method="post">
      <label className="detail-element detail-prompt profile-element" htmlFor="rating-add"><strong>Rating</strong></label>
      <textarea className="detail-element profile-element edit-content"  rows={1} type="text" id="rating-add" name="rating"  placeholder="0 - 10"/>
      <label className="detail-element detail-prompt profile-element" htmlFor="content-add"><strong>Content</strong></label>
      <textarea className="detail-element profile-element edit-content" rows={20} type="text" id="content-add" name="content"  placeholder="write your review"/>
      ...
      <div className="detail-element profile-element button-wrapper" >
        <button className="edit-area-button" type="submit">add</button>
